...
<task type="auto">
  ...
  <action>
    ...
    - **Stages Completed:**
      ...
      3. Data cleaning functions (plan 03a)
      4. Data cleaning execution (plan 03b)
      5. Distribution analysis and outlier detection (plan 04)
      6. External data scraping (plan 05a)
      7. Data enrichment pipeline (plan 05b)
      8. Quality assessment reporting (plan 06)
